...
Capybara.current_driver = driver || :driver_chrome
...
Capybara.register_driver :driver_mobile_iphone6_vertical_visible do |app|
  size = "375,667"  
...
Capybara.register_driver :driver_mobile_iphone6_vertical_headless do |app|
  size = "375,667"  
  user_agent = "Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1"
...
Capybara.register_driver :driver_mobile_iphone6_horizontal_visible do |app|
  size = "667,375"
  user_agent = "Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1"
  args = ["--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}"]  
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
...
Capybara.register_driver :driver_mobile_iphone6_horizontal_headless do |app|
  size = "667,375"
  user_agent = "Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1"
  args = ["--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}", "--no-sandbox", "--headless"]  
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
...
Capybara.register_driver :driver_mobile_iphone6plus_vertical_headless do |app|
  size = "414,738"
  user_agent = "Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1"
  args = ["--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}", "--no-sandbox", "--headless"]
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
...
Capybara.register_driver :driver_mobile_iphone6plus_horizontal_headless do |app|
  size = "667,375"
  user_agent = "Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1"
  args = ["--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}", "--no-sandbox", "--headless"]  
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
...
Capybara.register_driver :driver_ipad_vertical_visible do |app|
  ...
  args = ["--no-sandbox", "--headless", "--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}"]
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
  Capybara::Selenium::Driver.new(app, {:browser => :chrome, :options => options})
end
...
Capybara.register_driver :driver_mobile_samsungs6_vertical_headless do |app|
  size = "360,640"
...
Capybara.register_driver :driver_mobile_samsungs6_horizontal_headless do |app|
  size = "640,360"
  user_agent = "Mozilla/5.0 (Linux; Android 6.0.1; SM-G920V Build/MMB29K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Mobile Safari/537.36"
  args = ["--no-sandbox", "--headless", "--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}", "--no-sandbox", "--headless"]
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
...
Capybara.register_driver :driver_mobile_samsungsTabA_vertical_headless do |app|
  size = "600,1024"
  user_agent = "Mozilla/5.0 (Linux; Android 5.0.2; SAMSUNG SM-T550 Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.3 Chrome/38.0.2125.102 Safari/537.36"
  args = ["--no-sandbox", "--headless", "--window-size=#{size}", "--use-mobile-user-agent", "--disable-infobars", "--disable-notifications", "--user-agent=#{user_agent}", "--no-sandbox", "--headless"]
  options = Selenium::WebDriver::Chrome::Options.new(args: args)
